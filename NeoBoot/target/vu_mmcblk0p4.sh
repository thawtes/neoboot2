        ...
        if [ $BOXNAME = "vuzero4k" ] ; then                     
                ...
                if [ -e /.multinfo ]; then                                                                                                                             
                                ...
                                if [ -e $NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin ] ; then                                                                                                                                                                                                                       
                                    if [ -d /proc/stb ] ; then
                      	    	            dd if=$NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin of=/dev/mmcblk0p4
                                    fi
                                    echo "Boot - Flash. "                                                                                                                                                                                        
                                    ...
                                    if [ -e $NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin ] ; then
                                        ...
                                        if [ -d /proc/stb ] ; then
                                                    dd if=$NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin conv=noerror conv=sync of=/dev/mmcblk0p4
                                        fi                                                                                                                                              
