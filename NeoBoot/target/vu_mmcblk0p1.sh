        ...
        if [ $BOXNAME = "vuultimo4k" ] || [ $BOXNAME = "vusolo4k" ] || [ $BOXNAME = "vuuno4kse" ] || [ $BOXNAME = "vuuno4k" ]; then                     
                ...
                if [ -e /.multinfo ]; then                                                                                                                             
                                ...
                                if [ -e $NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin ] ; then                                                                                                                                                                                                                       
                                    if [ -d /proc/stb ] ; then
                      	    	            dd if=$NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin of=/dev/mmcblk0p1
                                    fi
                                    echo "Boot - Flash. "                                                                                                                                                                                        
                                    ...
                                    if [ -e $NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin ] ; then
                                        ...
                                        if [ -d /proc/stb ] ; then
                                                    dd if=$NEOBOOTMOUNT/ImagesUpload/.kernel/flash-kernel-$VUMODEL.bin conv=noerror conv=sync of=/dev/mmcblk0p1
                                        fi                                                                                                                                              
